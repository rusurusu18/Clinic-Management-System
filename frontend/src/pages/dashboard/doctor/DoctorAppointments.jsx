...
import { cancelAppointment, getAppointments, updateAppointment } from '../../../services/appointmentService.js';
...
const DoctorAppointments = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Appointments list */}
      <SectionCard title={`Appointments (${filtered.length})`} subtitle={loading ? 'Loading appointments...' : 'Click on a row to see full details'} 
        bodyClassName="p-0">
        {filtered.length === 0 ? (
